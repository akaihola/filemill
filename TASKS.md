...
- [x] #42 Mobile preview fills 90 vw with scroll-snap column peek; `@media (max-width: 700px)` in `styles.py`
...
- [x] #16 Bind address CLI option `--bind` / `-b` with `PYKOFINDER_BIND` env var
