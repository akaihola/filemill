"""Tests for pykofinder.vfs – VFSEntry, VFSRegistry, VFSProvider protocol, is_vfs_file."""
...
def test_truncate_short_string_unchanged():
    from pykofinder.vfs import _truncate
...
def test_vfs_registry_get_returns_none_when_empty():
    from pykofinder.vfs import VFSRegistry
...
def test_vfs_provider_protocol_is_runtime_checkable():
    from pykofinder.vfs import VFSProvider
