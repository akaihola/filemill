"""Tests for pykofinder.providers.sqlite – SQLiteProvider enumeration + preview."""
...
from pykofinder.providers.sqlite import (
    ROW_ICON,
    SCHEMA_ICON,
    TABLE_ICON,
    SQLiteProvider,
...
def test_list_entries_max_row_entries_cap(tmp_path, provider):
    from pykofinder.providers.sqlite import MAX_ROW_ENTRIES
