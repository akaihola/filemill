...
The column view is the heart of pykofinder. Each directory you click opens
...
```python src/pykofinder/columns.py
...
uv sync
python -c "
from pykofinder.columns import render_breadcrumb, entry_icon
from pathlib import Path
