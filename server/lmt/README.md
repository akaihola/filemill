# filemill – LMT milestones

This directory contains a literate-programming reconstruction of the
`filemill` Python source tree. Tangling the milestone files in order
...
- The literate milestones cover `pyproject.toml` and the Python source tree under `src/filemill/`.
