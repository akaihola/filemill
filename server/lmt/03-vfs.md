...
filemill doesn't just browse real directories. SQLite databases,
...
```python src/filemill/providers/__init__.py
...
uv sync
python -c "
from filemill.vfs import REGISTRY, VFSEntry, is_vfs_file
from pathlib import Path
