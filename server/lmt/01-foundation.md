...
The package init is empty – it simply marks `src/filemill/` as a Python
package.

<!--
```python src/filemill/__init__.py
```
-->
...
def main() -> None:
    ...
    print("filemill – not yet implemented (see later milestones)")
