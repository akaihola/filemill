...
filemill can be installed as a standalone app on any device that supports
...
The manifest tells the browser how to present filemill when installed.
...
```json src/filemill/static/manifest.json
{
  "name": "filemill",
  "short_name": "filemill",
...
```xml src/filemill/static/icons/icon.svg
...
python -c "
import cairosvg
cairosvg.svg2png(url='src/filemill/static/icons/icon.svg',
                 write_to='src/filemill/static/icons/icon-192.png',
                 output_width=192, output_height=192)
cairosvg.svg2png(url='src/filemill/static/icons/icon.svg',
                 write_to='src/filemill/static/icons/icon-512.png',
...
static = Path('src/filemill/static')
