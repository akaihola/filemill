...
```python src/filemill/providers/sqlite.py
...
```python src/filemill/providers/csv_provider.py
"""CSV VFS provider stub for filemill."""
...
```python src/filemill/providers/json_provider.py
"""JSON VFS provider for filemill."""
